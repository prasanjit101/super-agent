...
export default function BrowserStream({ browserAgent }: { browserAgent: BrowserAgent }) {
    ...
    return (
        ...
        >
            <ResizablePanel defaultSize={chatWidth} minSize={30}>
                <ChatInterface sandboxActive={sandboxActive} browserAgent={browserAgent} />
            </ResizablePanel>
            ...
            <ResizablePanel defaultSize={100 - chatWidth} minSize={30}>
                <div className="flex h-full flex-col">
                    ...
                    <div className="flex gap-4 p-2 px-6 border rounded-full max-w-3xl mx-auto">
                        ...
                        <Button disabled={!sandboxActive} onClick={toggleStream} variant="outline">
