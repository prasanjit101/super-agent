...
export default function BrowserAgentModal({ browserAgent, emptyState }: { browserAgent?: BrowserAgent; emptyState?: boolean }) {
		...
		<Dialog onOpenChange={setOpen} open={open}>
			...
			<DialogContent>
				...
				<div className="px-5 pb-5">
					<BrowserAgentForm closeModal={closeModal} browserAgent={browserAgent} />
				</div>
			</DialogContent>
		</Dialog>
	);
