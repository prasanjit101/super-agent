...
const BrowserAgentForm = ({
  ...
  const { mutate: createBrowserAgent, isPending: isCreating } =
    trpc.browserAgent.create.useMutation({
      onSuccess: (res) => onSuccess('create'),
      onError: (err) => onSuccess('create', { error: err.message }),
    });

  const { mutate: updateBrowserAgent, isPending: isUpdating } =
    trpc.browserAgent.update.useMutation({
      onSuccess: (res) => onSuccess('update'),
      onError: (err) => onSuccess('update', { error: err.message }),
    });

  const { mutate: deleteBrowserAgent, isPending: isDeleting } =
    trpc.browserAgent.delete.useMutation({
